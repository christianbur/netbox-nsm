    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rulebook_type",
                    models.CharField(default="security_rules", max_length=20),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="netbox_nsm__content_976b8a_idx",
                    )
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="netbox_nsm__object__66c665_idx",
                    ),
                    models.Index(
                        fields=["object_b_type", "object_b_id"],
                        name="netbox_nsm__object__4a8592_idx",
                    ),
                    models.Index(
                        fields=["propagation"], name="netbox_nsm__propaga_b861c2_idx"
                    ),
                ],
                "unique_together": {
        ...
        migrations.AddConstraint(
            model_name="rule",
            constraint=models.UniqueConstraint(
                fields=("rulebook", "name"), name="netbox_nsm_rule_unique_rulebook_name"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="netbox_nsm__assigne_eeac43_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="rulebookassignment",
            constraint=models.UniqueConstraint(
                ...
                name="netbox_nsm_rulebookassignment_unique_rulebook_assignment",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["content_type", "object_id"],
                name="netbox_nsm__content_350aea_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="ruleobjectitem",
