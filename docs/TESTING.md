...
Tests live under `netbox_nsm/tests/`. Shared bases and GraphQL helpers are in `netbox_nsm/tests/custom.py`. The suite covers API integration, rulebook/rules/matrix views, Security Panel, setup wizard, and related utilities.
