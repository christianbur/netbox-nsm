...
from netbox_nsm.analysis.ipa_object_node import _ipa_object_node_presentation
from netbox_nsm.analysis.ipa_object_node import _ipa_object_node_role_from_tree_node
from netbox_nsm.analysis.ipa_tree_dedupe import collapse_sibling_networks
from netbox_nsm.analysis.ipa_tree_dedupe import dedupe_by_network
from netbox_nsm.analysis.ipa_tree_dedupe import strip_redundant_parent_network
from netbox_nsm.analysis.ipa_tree_dedupe import strip_self_referential_redundant_networks
...
def _ipa_drilldown_nodes_are_shell_only(nodes, *, redundant_nets=()):
    ...
    if redundant_nets:
        ...
        if net is not None and any(net == redundant for redundant in redundant_nets):
            from netbox_nsm.analysis.ipa_tree_dedupe import _node_renders_self_reference
