...
class AnalyzerPickerAPIView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        from netbox_nsm.analyzer.picker import build_picker_tree
...
class AnalyzerAPIView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        from netbox_nsm.analyzer import node_from_object
        from netbox_nsm.analyzer.modes import get_filtered_edges, parse_analyzer_mode
