...
from netbox_nsm.api.serializers import FirewallFilterSerializer
...
class FirewallRuleFromSettingSerializer(PrimaryModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:firewallrulefromsetting-detail"
    )
...
class FirewallRuleThenSettingSerializer(PrimaryModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:firewallrulethensetting-detail"
    )
    assigned_object = serializers.SerializerMethodField(read_only=True)
...
class FirewallFilterRuleSerializer(PrimaryModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:firewallfilterrule-detail"
    )
