...
from netbox_nsm.models import NatRuleSet, NatRuleSetAssignment
from netbox_nsm.constants import (
    RULESET_ASSIGNMENT_MODELS,
)

from netbox_nsm.api.serializers import SecurityZoneSerializer


class NatRuleSetSerializer(NetBoxModelSerializer):
    url = HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:natruleset-detail"
    )
