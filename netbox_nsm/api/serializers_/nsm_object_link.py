...
__all__ = ("NSMObjectLinkSerializer",)


class NSMObjectLinkSerializer(NetBoxModelSerializer):
    url = HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:nsmobjectlink-detail"
    )
    ...
    class Meta:
        ...
        validators = [
            UniqueTogetherValidator(
                queryset=NSMObjectLink.objects.all(),
