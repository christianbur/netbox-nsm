...
from netbox_nsm.models import SecurityObjectAssignment
from .security_object import SecurityObjectSerializer


class SecurityObjectAssignmentSerializer(NetBoxModelSerializer):
    url = HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:securityobjectassignment-detail"
    )
    custom_object = SecurityObjectSerializer(nested=True, required=True)
