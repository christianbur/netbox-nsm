...
class SecurityPolicyRulebookSerializer(PrimaryModelSerializer):
    url = HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:securitypolicyrulebook-detail"
    )
...
class SecurityPolicyRuleSerializer(PrimaryModelSerializer):
    url = HyperlinkedIdentityField(
        view_name="plugins-api:netbox_nsm-api:securitypolicyrule-detail"
    )
    rulebook = SecurityPolicyRulebookSerializer(nested=True, required=True)
...
class SecurityPolicyAssignmentSerializer(NetBoxModelSerializer):
    rulebook = SecurityPolicyRulebookSerializer(nested=True, required=True)
