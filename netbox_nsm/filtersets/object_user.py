...
__all__ = ("ObjectUserFilterSet", "ObjectUserAssignmentFilterSet")


@register_filterset
class ObjectUserFilterSet(PrimaryModelFilterSet):
    class Meta:
        model = ObjectUser
        fields = ("id", "name", "entry_type", "dn", "description")
...
@register_filterset
class ObjectUserAssignmentFilterSet(AssignmentFilterSet):
    ...
    class Meta:
        ...
        fields = ("id", "user_id", "assigned_object_type", "assigned_object_id")
