...
@register_filterset
class SecurityZonePolicyRulebookFilterSet(PrimaryModelFilterSet):
    class Meta:
...
@register_filterset
class SecurityZonePolicyRuleFilterSet(PrimaryModelFilterSet):
...
@register_filterset
class SecurityZonePolicyRulebookAssignmentFilterSet(AssignmentFilterSet):
    rulebook_id = django_filters.ModelMultipleChoiceFilter(
        queryset=SecurityZonePolicyRulebook.objects.all(),
        label=_("Rulebook (ID)"),
    )
