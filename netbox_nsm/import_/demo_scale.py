...
__all__ = (
    ...
    "BENCH_DEMO_OCTET1",
    "BENCH_DEMO_OCTET2_BASE",
    "BENCH_DEMO_SUPERNET_CIDR",
...
# RFC 2544 benchmark space for NSM bench demos (separate from Enterprise 10.x).
BENCH_DEMO_OCTET1 = 198
BENCH_DEMO_OCTET2_BASE = 18
BENCH_DEMO_SUPERNET_CIDR = "198.18.0.0/13"
...
def _subnet_prefix_cidr(subnet_idx: int) -> str:
    """Map subnet index to a contiguous /24 in ``BENCH_DEMO_SUPERNET_CIDR``."""
...
def _wider_prefix_cidr(block_subnet_idx: int, prefix_len: int) -> str:
    """Map block start subnet index to a /20 or /16 in ``BENCH_DEMO_SUPERNET_CIDR``."""
