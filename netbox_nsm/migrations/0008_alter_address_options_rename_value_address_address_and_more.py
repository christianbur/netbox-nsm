...
import netbox_nsm.validators.fqdn
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("netbox_nsm", "0007_policerassignment"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                max_length=255,
                null=True,
                validators=[netbox_nsm.validators.fqdn.validate_fqdn],
            ),
        ),
            ...
            field=models.ForeignKey(
                ...
                limit_choices_to=models.Q(
                    models.Q(
                        ...
                        models.Q(
                            ("app_label", "netbox_nsm"), ("model", "addressset")
                        ),
                        _connector="OR",
                    )
                ),
