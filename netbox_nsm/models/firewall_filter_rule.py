...
from netbox_nsm.constants import FILTER_SETTING_ASSIGNMENT_MODELS
...
class FirewallRuleFromSetting(FirewallRuleSettingMixin):
    ...
    def get_absolute_url(self):
        return reverse(
            "plugins:netbox_nsm:firewallrulefromsetting", args=[self.pk]
        )
...
class FirewallRuleThenSetting(FirewallRuleSettingMixin):
    ...
    def get_absolute_url(self):
        return reverse(
            "plugins:netbox_nsm:firewallrulethensetting", args=[self.pk]
        )
...
class FirewallFilterRule(ContactsMixin, PrimaryModel):
    ...
    from_settings = GenericRelation(
        to="netbox_nsm.FirewallRuleFromSetting",
    ...
    then_settings = GenericRelation(
        to="netbox_nsm.FirewallRuleThenSetting",
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_nsm:firewallfilterrule", args=[self.pk])
