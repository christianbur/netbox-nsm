...
class NatPool(ContactsMixin, PrimaryModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_nsm:natpool", args=[self.pk])
...
class NatPoolAssignment(NetBoxModel):
    ...
    pool = models.ForeignKey(to="netbox_nsm.NatPool", on_delete=models.CASCADE)

    clone_fields = ("assigned_object_type", "assigned_object_id")

    prerequisite_models = ("netbox_nsm.NatPool",)
