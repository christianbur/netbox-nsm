...
from netbox_nsm.constants import RULE_ASSIGNMENT_MODELS
...
class NatRule(ContactsMixin, PortsMixin, PrimaryModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_nsm:natrule", args=[self.pk])
...
class NatRuleAssignment(NetBoxModel):
    ...
    rule = models.ForeignKey(to="netbox_nsm.NatRule", on_delete=models.CASCADE)

    clone_fields = ("assigned_object_type", "assigned_object_id")

    prerequisite_models = ("netbox_nsm.NatRule",)
