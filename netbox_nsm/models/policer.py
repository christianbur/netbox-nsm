...
from netbox_nsm.choices import ForwardingClassChoices, LossPriorityChoices
...
class Policer(ContactsMixin, PrimaryModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_nsm:policer", args=[self.pk])
...
class PolicerAssignment(NetBoxModel):
    ...
    policer = models.ForeignKey(to="netbox_nsm.Policer", on_delete=models.CASCADE)

    clone_fields = ("assigned_object_type", "assigned_object_id")

    prerequisite_models = ("netbox_nsm.Policer",)
