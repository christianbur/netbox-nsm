...
class PropertyType(PrimaryModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                Lower("name"),
                name="netbox_nsm_propertytype_name_ci_unique",
            )
        ]
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="netbox_nsm_propertyfield_unique_name",
            )
        ]
...
class Property(PrimaryModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=("security_property_type", "name"),
                name="netbox_nsm_property_unique_type_name",
            ),
            models.UniqueConstraint(
                fields=("security_property_type", "source_model", "source_pk"),
                name="netbox_nsm_property_unique_type_source",
            ),
        ]
...
@register_search
class PropertyTypeIndex(SearchIndex):
    model = PropertyType
    fields = (
        ("name", 200),
        ("slug", 200),
