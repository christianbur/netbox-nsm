...
class SecurityZonePolicy(ContactsMixin, PrimaryModel):
    ...
    source_zone = models.ManyToManyField(
        to="netbox_nsm.SecurityZone",
        related_name="source_zone_policies",
        blank=True,
    )
    destination_zone = models.ManyToManyField(
        to="netbox_nsm.SecurityZone",
    ...
    prerequisite_models = ("netbox_nsm.SecurityZone",)
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_nsm:securityzonepolicy", args=[self.pk])
