(function () {
  ...
  function areasFieldEl() {
    return (
      document.querySelector("[name='field_slugs']")
      || document.querySelector("input[name='field_slugs']")
    );
  }
  ...
  function selectedAreaIds() {
    const checked = document.querySelectorAll("input[name='field_slugs']:checked");
    if (checked.length) {
