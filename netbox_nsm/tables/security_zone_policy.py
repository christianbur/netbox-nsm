...
from netbox_nsm.models import SecurityZonePolicy
...
class SecurityZonePolicyTable(NetBoxTable):
    ...
    source_zone = ManyToManyColumn(
        linkify_item=True,
        orderable=False,
        linkify=True,
        verbose_name=_("Source Zone"),
    )
    destination_zone = ManyToManyColumn(
        linkify_item=True,
        orderable=False,
        linkify=True,
        verbose_name=_("Destination Zone"),
    )
