...
class IpaCellObjectTreeTests(SimpleTestCase):
    ...
    @patch("netbox_nsm.analysis.ipa_object_tree._ipa_prefix_for_cell_object", return_value=None)
    ...
    def test_group_coverage_marks_visible_and_membership_groups(self):
        ...
        with patch(
            "netbox_nsm.analysis.ipa_object_tree._ipa_object_group_members",
    ...
    def test_synthesize_ipam_parent_prefix_nests_hosts(
        ...
        with patch(
            "netbox_nsm.analysis.ipa_object_tree._lookup_containing_prefix_for_ipa_cell_node",
            return_value=prefix,
        ):
            with patch(
                "netbox_nsm.analysis.ipa_object_tree._ipa_prefix_for_cell_object",
                return_value=None,
            ):
    ...
    def test_mark_ipa_cell_tree_parent_hints_uses_nearest_prefix_ancestor(self):
        from netbox_nsm.analysis.ipa_object_tree import _mark_ipa_cell_tree_parent_hints
    ...
    def test_addr_node_prefix_cidr_accepts_nsm_address_host_ref(self):
        from netbox_nsm.analysis.addr_ip_refs import _addr_node_prefix_cidr
    ...
    def test_addr_tree_node_network_falls_back_to_prefix_display_cidr(self):
        from netbox_nsm.analysis.addr_tree import _addr_tree_node_network
    ...
    def test_synthesize_ipa_cell_ipam_parent_prefixes_unit(self):
        ...
        with patch(
            ...
            with patch(
                "netbox_nsm.analysis.ipa_object_tree._reorganize_ipa_object_tree_by_ipam_prefix_hierarchy",
    ...
    def test_synthesize_ipa_cell_ipam_parent_prefixes_for_collapsed_group(self):
        ...
        with patch(
            "netbox_nsm.analysis.ipa_object_tree._enrich_ipa_node_from_resolved_prefix",
...
class IpaCellTreeDisplayTests(SimpleTestCase):
    ...
    def test_insert_ipam_filler_prefixes_inserts_missing_slash16(self):
        ...
        with patch(
            "netbox_nsm.analysis.ipa_object_tree._ipa_resolve_netbox_prefix_for_tree_node",
            side_effect=lambda node, _obj, **kwargs: slash24 if node.get("pk") == "24" else None,
        ):
            with patch(
                "netbox_nsm.analysis.ipa_object_tree._build_ipa_ipam_filler_prefix_node",
    ...
    @patch("netbox_nsm.analysis.ipa_object_tree._attach_ipa_drilldown_meta")
    @patch("netbox_nsm.analysis.ipa_object_tree._ipa_object_drilldown_has_visible_content", return_value=False)
    @patch("netbox_nsm.analysis.ipa_object_tree._attach_ipa_object_tree_ipam_stats")
    @patch("netbox_nsm.analysis.ipa_object_tree._attach_ipa_object_tree_ip_meta")
    @patch("netbox_nsm.analysis.addr_analysis_utils._addr_group_members", return_value=[])
    ...
    def test_large_group_expands_only_cell_co_selected_members(
        ...
        from netbox_nsm.analysis.ipa_object_tree import IPA_CELL_GROUP_FULL_EXPAND_MAX
...
class IpaCellTreeDrilldownGuardTests(SimpleTestCase):
    ...
    @patch("netbox_nsm.analysis.ipa_object_tree._hub._prefix_ipam_stats")
    @patch("netbox_nsm.analysis.ipa_object_tree._hub._attach_ipam_stats_meta")
    def test_attach_ipam_stats_uses_netbox_counts_not_visible_subtree(
        ...
        with patch(
            ...
            from netbox_nsm.analysis.ipa_object_tree import _attach_ipa_object_tree_ipam_stats
...
class IpaCellDisplayHintTests(SimpleTestCase):
    def test_attach_cell_group_collapse_hints_from_count(self):
        from netbox_nsm.analysis.ipa_object_tree import _attach_ipa_cell_display_hints
    ...
    def test_annotate_ipa_cell_tree_depth(self):
        from netbox_nsm.analysis.ipa_object_tree import _annotate_ipa_cell_tree_depth
    ...
    def test_ipa_cell_tree_flat_row_is_visible_excludes_filler(self):
        from netbox_nsm.analysis.ipa_object_tree import _ipa_cell_tree_flat_row_is_visible
...
class IpaCellAddressFieldTests(SimpleTestCase):
    ...
    @patch("netbox_nsm.analysis.ipa_object_tree._ipa_resolve_group_anchor_member")
    @patch("netbox_nsm.analysis.ipa_object_tree._ipa_object_expands_members", return_value=True)
    @patch("netbox_nsm.analysis.ipa_object_tree._ipa_object_node_role_from_tree_node", return_value=IPA_NODE_ROLE_GROUP)
    ...
    def test_attach_cell_address_fields_backfills_url_for_group_member(self):
        ...
        with patch(
            "netbox_nsm.analysis.ipa_object_tree._ipa_object_node_role_from_tree_node",
