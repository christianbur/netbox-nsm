...
class IpaObjectNodeRoleTests(SimpleTestCase):
    ...
    @patch("netbox_nsm.analyzers.ip_analyzer.ipa_object_node._hub._ipam_obj_from_ip_ref")
    def test_role_from_polymorphic_address_ref_resolves_prefix(self, ipam_fn):
        ...
        with patch(
            "netbox_nsm.analyzers.ip_analyzer.ipa_object_node._ipa_object_node_role_from_ipam_obj",
    ...
    @patch("netbox_nsm.analyzers.ip_analyzer.ipa_object_node._hub._addr_ip_ref", return_value=None)
    ...
    @patch("netbox_nsm.analyzers.ip_analyzer.ipa_object_node._hub._addr_ip_ref")
    def test_apply_presentation_prefix_node(self, ip_ref_fn):
        ...
        with patch(
            "netbox_nsm.analyzers.ip_analyzer.ipa_object_node._hub._addr_ip_ref_node_dict",
            side_effect=lambda r: dict(r),
        ), patch(
            "netbox_nsm.analyzers.ip_analyzer.ipa_object_node._hub._attach_addr_node_prefix_display",
