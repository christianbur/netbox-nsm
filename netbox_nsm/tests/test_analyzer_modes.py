...
class FilterEdgesForModeTests(SimpleTestCase):
    ...
    @patch("netbox_nsm.analyzer.modes.get_security_allowed_ct_ids", return_value=frozenset({10}))
...
class BuildPickerTreeModeTests(SimpleTestCase):
    def test_security_mode_filters_l1_and_l2(self):
        ...
        with patch("netbox_nsm.analyzer.node_from_object", return_value=_node(1)), patch.object(
            ...
            "netbox_nsm.analyzer.modes.get_filtered_edges", side_effect=filtered_edges
        ):
