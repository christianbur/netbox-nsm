...
class IpAnalysisObjectDrilldownApiTests(SimpleTestCase):
    ...
    @patch("netbox_nsm.views.ip_analysis_object_api.render_to_string")
    @patch("netbox_nsm.views.ip_analysis_object_api._build_object_drilldown_nodes")
    @patch("netbox_nsm.views.ip_analysis_object_api.ContentType")
