...
class ObjectTypeElementsApiViewTests(TestCase):
    ...
    @patch("netbox_nsm.security.views.object_link.is_linkable_content_type", return_value=True)
    def test_empty_query_returns_first_page(self, _linkable):
    ...
    @patch("netbox_nsm.security.views.object_link.is_linkable_content_type", return_value=True)
    def test_single_char_query_not_rejected(self, _linkable):
