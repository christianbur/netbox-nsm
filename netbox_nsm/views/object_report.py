...
from netbox_nsm.objects.nsm_config_permissions import VIEW_CUSTOM_OBJECT_TYPE
...
class ObjectReportView(LoginRequiredMixin, View):
    ...
    def _context(self, request):
        from netbox_nsm.object_report.object_report import (
    ...
    def _export_toml(self, request):
        from netbox_nsm.object_report.jobs import get_latest_object_report_job
        from netbox_nsm.object_report.object_report import localize_object_report
