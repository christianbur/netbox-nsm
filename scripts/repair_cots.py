...
# Schema-ID Mappings
AUTO_IDS = {'name': 1, 'slug': 2, 'description': 3, 'owner_group': 4,
            'owner': 5, 'comments': 6, 'color': 7}
USER_IDS = {
    'nsm_action':    {},
...
for cot in CustomObjectType.objects.all().order_by('slug'):
    ...
    base_cols = {'id', 'created', 'last_updated', 'custom_field_data',
                 'tags', 'bookmarks', 'journal_entries', 'subscriptions'}
